...
board_info() {
          ...
          [[ -z "${flavor}" ]] && flavor=$(grep -m1 -oP "(?<=^ro.product.build.type=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${release}" ]] && release=$(grep -m1 -oP "(?<=^ro.product.build.version.release=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${id}" ]] && id=$(grep -m1 -oP "(?<=^ro.product.build.id=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${tags}" ]] && tags=$(grep -m1 -oP "(?<=^ro.product.build.tags=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${manufacturer}" ]] && manufacturer=$(grep -m1 -oP "(?<=^ro.product.manufacturer=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${brand}" ]] && brand=$(grep -m1 -oP "(?<=^ro.product.brand=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${codename}" ]] && codename=$(grep -m1 -oP "(?<=^ro.product.device=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${incremental}" ]] && incremental=$(grep -m1 -oP "(?<=^ro.product.build.version.incremental=).*" -hs product/etc/build*.prop)
          ...
          [[ -z "${build_date}" ]] && build_date=$(grep -m1 -oP "(?<=^ro.product.build.date=).*" -hs product/etc/build*.prop)
          build_date_utc=$(grep -m1 -oP "(?<=^ro.product.build.date.utc=).*" -hs boot/ramdisk/system/etc/ramdisk/build.prop)
          [[ -z "${build_date_utc}" ]] && build_date_utc=$(grep -m1 -oP "(?<=^ro.product.build.date.utc=).*" -hs product/etc/build*.prop)
